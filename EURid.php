...
function EURid_RegisterNameservers($params) {
    $return = array();

    return $return;
}

function EURid_GetNameserversStatus($params) {
...
function EURid_SaveRegistrarLock($params) {
    $return = array();
...
function EURid_IDProtectToggle($params) {
    $return = array();
...
function EURid_SetDNSSEC($params) {
    $return = array();
...
function EURid_SetLocalPresence($params) {
    $return = array();
...
function EURid_RenewSync($params) {
    return array(
        "expirydate" => date('Y-m-d', strtotime($params['additionalfields']['dummyexpirydate'])),
        "completed" => true
    );
...
function EURid_RegisterContacts($params) {
    $return = array();

    return $return;
}

function EURid_GetContactsStatus($params) {
    return array(
        "completed" => true,
        "additionalfields" => array(
            "ownerContactId" => "1",
...
function EURid_RequestDeleteSync($params) {
    return array("completed" => true);
}

function EURid_checkAvailability($params) {
...
function EURid_checkTransfer($params) {
    return array('status' => 1, 'renewRequired' => 0, 'msg' => _('This domain is available for transfer'));
}

function EURid_ValidateAdditionalFields($params) {
    if ($params['TestMode'] == 'on') {
...
function EURid_SetAutoRenew($params) {
    $return = array();
...
function EURid_GetAutoRenewStatus($params) {
    return array("completed" => true);
}
